...
router.post("/", routes_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const post = yield prisma.post.findUnique({ where: { id: req.body.postId } });
...
// UPDATE a comment
router.put("/:id", routes_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const comment = yield prisma.comment.findUnique({
        where: { id: parseInt(req.params.id) },
    });
    if (!comment) {
...
// DELETE a comment
router.delete("/:id", routes_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
